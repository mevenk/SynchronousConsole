...
class GuiWorker extends SwingWorker<Integer, Integer> {
	...
	/*
	 * This should just create a frame that will hold a progress bar until the work
	 * is done. Once done, it should remove the progress bar from the dialog and add
	 * a label saying the task complete.
	 */
